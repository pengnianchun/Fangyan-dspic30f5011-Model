...
#define RAIN_HIGH       gYBKey.BITS.k0 //雨刮快档
#define RAIN_SLOW	    gYBKey.BITS.k1 //雨刮慢档
#define RAIN_SPRAY  	gYBKey.BITS.k2 //雨刮喷水档
#define RAIN_INTERVAL	gYBKey.BITS.k3 //雨刮间歇档
#define K_ON	        gYBKey.BITS.k4 //钥匙ON
...
extern unsigned int ICcan_count; //仪表CAN
...
extern unsigned int wipe_wpp_time;
